...
if __name__ == '__main__':
    model = YOLO('/root/autodl-tmp/ultralytics-yolo11and12/ultralytics-yolo11-main/ultralytics/cfg/models/8/yolov8.yaml') # YOLO11
    # model.load('yolo11n.pt') # loading pretrain weights
    model.train(data='/root/autodl-tmp/ultralytics-yolo11and12/ultralytics-yolo11-main/data/data.yaml',
                cache=False,
                imgsz=640,
                epochs=300,
                batch=32,
